...
<a href="/files/Panel_Regression_with_ERS.pdf" style="text-decoration: underline; font-weight: bold; color: black;">
<span onmouseover="this.style.color='#659EC7'" onmouseout="this.style.color='black'">Panel Regression with Endogenous Regime Switching</span></a> [[Draft]](/files/Panel_Regression_with_ERS.pdf)
</summary>
